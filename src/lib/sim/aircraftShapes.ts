...
const META: Record<string, FamilyMeta> = {
  ...
  A319: { family: 'narrow', engines: 2, mount: 'wing', sweepDeg: 25, fuselageW: 3.95 },
  B739: { family: 'narrow', engines: 2, mount: 'wing', sweepDeg: 25, fuselageW: 3.8 },
  CRJ7: { family: 'narrow', engines: 2, mount: 'tail', sweepDeg: 25, fuselageW: 2.7 },
